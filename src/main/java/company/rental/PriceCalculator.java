...
class PriceCalculator {
    ...
    public static float calculate(Object[] scooterData, Boolean isImmediatePayment, UsageTime minutes, float priceAmountClientMultiplicationFactor, float subscriptionDiscount) {
