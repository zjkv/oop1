...
class PriceCalculatorTest extends BaseTest {
    ...
    void shouldApplyDiscountToCalculatedPriceBasedOnSubscriptionWhenRidesAmountMatchesValueInSubscription() {
        ...
        final var regularPrice = PriceCalculator.calculate(scooterData, isImmediatePayment, minutes, priceAmountClientMultiplicationFactor, Subscription.ZERO_TO_NINE, 8);
        //using ten_to_nineteen rents subscription - multiplier of discount * 0.9
        final var priceWith0Point9Multiplier = PriceCalculator.calculate(scooterData, isImmediatePayment, minutes, priceAmountClientMultiplicationFactor, Subscription.TEN_TO_NINETEEN, 12);
    ...
    void shouldApplyDefaultDiscountToCalculatedPriceBasedOnSubscriptionWhenRidesAmountDoesNotMatchValueInSubscription() {
        ...
        //when
        //using ten_to_nineteen rents subscription - multiplier of discount * 0.9
        final var tenToNineteenSubscriptionPrice = PriceCalculator.calculate(scooterData, isImmediatePayment, minutes, priceAmountClientMultiplicationFactor, Subscription.TEN_TO_NINETEEN, 3);
        //using twenty_to_twenty_nine rents subscription - multiplier of discount * 0.8
        final var twentyToTwentyNineSubscriptionPrice = PriceCalculator.calculate(scooterData, isImmediatePayment, minutes, priceAmountClientMultiplicationFactor, Subscription.TWENTY_TO_TWENTY_NINE, 8);
